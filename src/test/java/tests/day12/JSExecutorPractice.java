...
public class JSExecutorPractice {
    ...
    public void test1() {
        ...
        public void test2 () {
            ...
            // argument it's an array first webelement after comma
            // argyments[0] = link web element, it can be any web element
    ...
    public void test3(){
        ...
        // Example 1 is a beggining of the phrase <a href='http:'> Example1.....</a>
        ...
        // or for scrolling
        // argument[0].click() is an alternative for link1.click()
