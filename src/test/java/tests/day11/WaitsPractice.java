...
public class WaitsPractice {
    ...
    public void test1(){
        ...
        // Example 2 - only part of the link
    ...
    public void test2(){
        driver.findElement(By.linkText("Dynamic Loading")).click();
        // select Example #1 | xpath alternative //a[cotains9text(),'Example 2']
        ...
        // we must provide webdriver object and peroid of time
        // within this period of time selenium will check every 500 milliseconds
        // if conditions is true, if condition is met, no need to wait longer
        // your script will continue executing | in this case waiting period is 10 seconds
        WebDriverWait wait = new WebDriverWait(driver,10);
        // how to aplly condition | ExpectedConditions.condition
        // in this exapmle, selenium webdriver will wait up to 10 seconds, untill element is visible
        // if wait time will expire, yur test will fail ( due to exception)
        wait.until(ExpectedConditions.visibilityOf(userNameInputBox));

        userNameInputBox.sendKeys("tomsmmith");
        ...
        // this is a webelement that represent submit button
        ...
        String expectedMessage = "Welcome to the Secure Area. When you are done click logout button.";
