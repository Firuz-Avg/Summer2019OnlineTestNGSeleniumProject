...
public class TestNGPractice {
    ...
    public void test() {
        ...
        // if no  - it will throw exception in the console what was expected
...
//        }
        ...
        @Test(description = "Verifuing title of the practice website")
        ...
        public void verifyHeadingIsDisplayed(){
            ...
            // Element is not visible -- will be printed it's element is there, but not visible
