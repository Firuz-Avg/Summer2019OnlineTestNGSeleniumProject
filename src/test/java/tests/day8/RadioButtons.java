...
//        this is step is common for all test cases
    ...
    public void test3() {
        ...
        // isEnaabled() will return true if button is available for interaction
    ...
    public void test4() {
        // how to find all radio butoons?
        // find all radio buttons
        // any radio button will have type='radio'
        List<WebElement> radioButoons = driver.findElements(By.cssSelector("input[type='radio']"));
        // let's click only if button is not clicked and is available for clicking
        for (WebElement button : radioButoons) {
            // if button is available for clicking and not clicked yet
            if (button.isEnabled() && !button.isSelected()) {
                // then click on it

                button.click();
                // in htis case, id attribute represents a name of the color
