...
//    </select>
    ...
    @Test(description = "Select aoption 2 from the dropdown")
    public void test1(){
        ...
        // <option value="1">Option 1</option> value is 1, Option 1 is a visible text, in between >Tetx< (in between angled brackets)
        select.selectByVisibleText("Option 2");
        BrowserUtils.wait(2);
        // how to verify that aoption 2 is selected
    ...
    public void test2() {
        ...
        // hot to print every option, as a text, one by one
